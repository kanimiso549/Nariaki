...
TARGET_CHANNEL_ID = 1405219542120136837
...
class Egg_meme(commands.Cog):
    ...
    @app_commands.command(name="egg_meme", description="卵鯖ミームが出てくるよ！")
    ...
    @app_commands.command(name="meme_reload", description="メディアファイルを再読み込みします")
    @app_commands.check(has_allowed_role)
...
async def setup(bot: commands.Bot):
    await bot.add_cog(Egg_meme(bot))
